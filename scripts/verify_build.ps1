...
$ExePath = Join-Path $ProjectRoot "dist\Yishu\Yishu.exe"
$SerifFontPath = Join-Path $ProjectRoot "dist\Yishu\_internal\assets\fonts\NotoSerifSC-VF.ttf"
$LucideIconPath = Join-Path $ProjectRoot "dist\Yishu\_internal\assets\icons\lucide\play.svg"
$ChannelIconPath = Join-Path $ProjectRoot "dist\Yishu\_internal\assets\icons\lucide\scan-text.svg"
$LucideLicensePath = Join-Path $ProjectRoot "dist\Yishu\_internal\assets\icons\lucide\LICENSE"
